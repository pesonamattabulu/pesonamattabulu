      ...
      <main className="flex-grow max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 items-start">
          ...
          <div className="bg-[#FFFDD0] p-4 sm:p-6 rounded shadow-md text-black">
            ...
            {/* Varian */}
            <div className="mb-4">
              <p className="text-lg sm:text-xl font-semibold mb-2">Digunakan Untuk</p>
              <ul className="space-y-1 text-base sm:text-lg font-light">
                <li><span className="text-yellow-600">✅</span> Bahan Masak</li>
                <li><span className="text-yellow-600">✅</span> Obat Herbal/Jamu</li>
              </ul>
            </div>
